...
// and an address lookup through a C symbol allowing clients to dlopen CppInterOp
// with RTLD_LOCAL, and automatically assign the API during runtime.
//
//===----------------------------------------------------------------------===//
...
#define CPPINTEROP_API_TABLE                                                     \
  ...
  DISPATCH_API(GetQualifiedCompleteName, decltype(&CppImpl::GetQualifiedCompleteName))    \
  ...
  DISPATCH_API(IsFunctionPointerType, decltype(&CppImpl::IsFunctionPointerType))          \
  ...
  DISPATCH_API(GetScopeFromCompleteName, decltype(&CppImpl::GetScopeFromCompleteName))    \
  ...
  DISPATCH_API(IsTemplateSpecialization, decltype(&CppImpl::IsTemplateSpecialization))    \
  ...
  DISPATCH_API(HasDefaultConstructor, decltype(&CppImpl::HasDefaultConstructor))          \
  ...
  DISPATCH_API(GetFunctionReturnType, decltype(&CppImpl::GetFunctionReturnType))          \
  ...
  DISPATCH_API(GetFunctionsUsingName, decltype(&CppImpl::GetFunctionsUsingName))          \
  DISPATCH_API(GetFunctionNumArgs, decltype(&CppImpl::GetFunctionNumArgs))                \
  DISPATCH_API(GetFunctionRequiredArgs, decltype(&CppImpl::GetFunctionRequiredArgs))      \
  ...
  DISPATCH_API(GetFunctionArgDefault, decltype(&CppImpl::GetFunctionArgDefault))          \
  DISPATCH_API(IsConstMethod, decltype(&CppImpl::IsConstMethod))                          \
  DISPATCH_API(GetFunctionTemplatedDecls, decltype(&CppImpl::GetFunctionTemplatedDecls))  \
  DISPATCH_API(ExistsFunctionTemplate, decltype(&CppImpl::ExistsFunctionTemplate))        \
  ...
  DISPATCH_API(GetClassTemplatedMethods, decltype(&CppImpl::GetClassTemplatedMethods))    \
  DISPATCH_API(BestOverloadFunctionMatch, decltype(&CppImpl::BestOverloadFunctionMatch))  \
  DISPATCH_API(GetOperatorFromSpelling, decltype(&CppImpl::GetOperatorFromSpelling))      \
  ...
  DISPATCH_API(BeginStdStreamCapture, decltype(&CppImpl::BeginStdStreamCapture))          \
  DISPATCH_API(MakeFunctionCallable, CppImpl::JitCall (*)(CppImpl::TCppConstFunction_t))  \
  DISPATCH_API(GetFunctionAddress, CppImpl::TCppFuncAddr_t (*)(CppImpl::TCppFunction_t))  \
