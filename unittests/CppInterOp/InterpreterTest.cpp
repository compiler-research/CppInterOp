...
TYPED_TEST(CPPINTEROP_TEST_MODE, Interpreter_ActivateInterpreter) {
  ...
  EXPECT_TRUE(Cpp::Evaluate("__cplusplus", nullptr) == 202002L)
  ...
  EXPECT_TRUE(Cpp::Evaluate("__cplusplus", nullptr) == 201402L);

  Cpp::DeleteInterpreter(Cpp14);
  EXPECT_EQ(Cpp::GetInterpreter(), Cpp20);

  EXPECT_TRUE(Cpp::ActivateInterpreter(Cpp17));
  EXPECT_TRUE(Cpp::Evaluate("__cplusplus", nullptr) == 201703L);
}
...
TYPED_TEST(CPPINTEROP_TEST_MODE, Interpreter_CreateInterpreter) {
  ...
  Cpp::Declare("#if __cplusplus==201402L\n"
                   ...
                   "void cppUnknown() {}\n"
                   "#endif", false);
  EXPECT_TRUE(Cpp::GetNamed("cpp14", nullptr));
  EXPECT_FALSE(Cpp::GetNamed("cppUnknown", nullptr));
  ...
  Cpp::Declare("#if __cplusplus==201703L\n"
                   ...
                   "void cppUnknown() {}\n"
                   "#endif", false);
  EXPECT_TRUE(Cpp::GetNamed("cpp17", nullptr));
  EXPECT_FALSE(Cpp::GetNamed("cppUnknown", nullptr));
