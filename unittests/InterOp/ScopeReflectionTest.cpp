...
TEST(ScopeReflectionTest, GetScopefromCompleteName) {
  ...
  Sema *S = &Interp->getCI()->getSema();
  EXPECT_EQ(
      InterOp::GetCompleteName(InterOp::GetScopeFromCompleteName(S, "N1")),
      "N1");
  EXPECT_EQ(
      InterOp::GetCompleteName(InterOp::GetScopeFromCompleteName(S, "N1::N2")),
      "N1::N2");
  EXPECT_EQ(InterOp::GetCompleteName(
...
TEST(ScopeReflectionTest, GetNamed) {
  ...
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "i", cl_C)),
            "N1::N2::C::i");
  EXPECT_EQ(InterOp::GetCompleteName(en_E), "N1::N2::C::E");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "A", en_E)),
            "N1::N2::C::A");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "B", en_E)),
            "N1::N2::C::B");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "A", cl_C)),
            "N1::N2::C::A");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "B", cl_C)),
            "N1::N2::C::B");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetNamed(S, "S", cl_C)),
            "N1::N2::C::S");
}
...
TEST(ScopeReflectionTest, GetParentScope) {
  ...
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetParentScope(int_i)),
            "N1::N2::C");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetParentScope(en_E)),
            "N1::N2::C");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetParentScope(en_A)),
            "N1::N2::C::E");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetParentScope(en_B)),
            "N1::N2::C::E");
}
...
TEST(ScopeReflectionTest, GetScopeFromType) {
  ...
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetScopeFromType(&QT1)), "N::C");
  EXPECT_EQ(InterOp::GetCompleteName(InterOp::GetScopeFromType(&QT2)), "N::S");
  EXPECT_EQ(InterOp::GetScopeFromType(&QT3), (cling::InterOp::TCppScope_t)0);
}
